...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.spaced.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.spaced.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.spaced
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.spaced.rc \
    android.hardware.wifi@1.0-service.spaced.xml
